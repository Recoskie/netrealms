...
class Pathfinder:
    ...
    def calculatePath(self, screen, x, y):
        ...
        self.variables['pathFinderPoints'] = self.findPath(screen, self.unit.physics['x'] + 32, self.unit.physics['y'] + 48, int(x / 32)*32, int(y / 32 + 0.5)*32, self.currentMap.tiles['blocked'])
